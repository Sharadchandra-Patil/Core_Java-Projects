package com.customer_tester;

import static com.customer.utils.CollectionUtils.readySampleData;
import static com.customer.utils.CustomerServices.*;
import static com.customer.utils.custom_sorting.CustomerSorting.*;
...
public class CustomerManagement {
	...
	public static void customerManagement() {
		System.out.println("\n***************  Welcome to Credit card and Insurance Service Portal  ******************");
		...
		try  {
			...
			while (true) {
				 ...
				 * ordering with anonymous inner class)
				 */
